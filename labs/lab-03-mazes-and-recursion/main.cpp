...
//
//       // Loop through elements, return true if key found.
...
//     // Determine if "key" is one of the values in numbers[0..n-1].
//
//     // Base case, vector is empty, key not found
//     if (n == 0)
//     {
//         return false;
//     }
//
//     // Check last element for key
...
//
//     // loop through elements and return false if mismatch found
//     for (size_t idx = 0; idx < n; ++idx)
//     {
//         if(numbers1.at(idx) != numbers2.at(idx))
//         {
//             return false;
//         }
//     }
...
//     // iterativeAreIdentical(numbers1, number2, 5) should return false.
//
//     // Base case: empty vector is always a match.
//     if (n == 0)
//     {
//         return true;
//     }
//
//     // Compare last elements for mismatch
//     if (numbers1.at(n-1) != numbers2.at(n-1))
//     {
//         return false;
//     }
//
//     // recursively compare for mismatches
...
//
//     // if string is empty or 1 character, return true.
//     if (s.size() <= 1)
//     {
//         return true;
//     }
//
//     // Use 2 points and move inward to the middle.
//     for (size_t idx = 0, jdx = s.size() -1; idx < jdx; ++idx, --jdx)
//     {
//         if(s.at(idx) != s.at(jdx))
//         {
//             return false;
//         }
//     }
...
//
//    // Base Case: if you meet in the middle or cross it, then it is a palindrome
//    if (leftIdx >= rightIdx)
//    {
//         return true;
//    }
//
//     // if a mismatch is found before finishing, return false, not palindrome
...
//
//     int count = 0;
//     // loop through the elements to find inversions, increment count if inversion found
...
//
//      // Base Case: If less than 2 elements, no pair to check
//      if (n < 2)
//     {
//         return 0;
//     }
//      // When n == 2, exactly 1 par to compare
//     if (n == 2 && v.at(0) > v.at(1))
//     {
//         return 1;
//     }
//
//     // recursively search for inversions from last two elements (n-2  and n-1)
//     if (v.at(n-2) > v.at(n-1))
//     {
//         return 1 + countInversionsRecursively(v, n-1);
//     }
//     // Runs if the previous recursive count returns false.
//     return countInversionsRecursively(v, n-1);
// }
//
//
// // Helper function for iterativePalindrome2 and recursivePalindrome2
// // Complete at home
// //void checkAlpha(const std::string &s, int &idx, int &jdx)
// //{
// //    while (!isalpha(s.at(idx)))
// //    {
// //        ++idx;
// //    }
// //    while (!isalpha(s.at(jdx)))
// //    {
// //        --jdx;
// //    }
// //}
...
//
//
// // Function to be completed at Home
...
//
// //for (int idx = 0, jdx = s.size() -1; idx < jdx; ++idx, --jdx)
// //{
// //    checkAlpha(s, idx, jdx);
// //
// //    if (s.at(idx) != s.at(jdx))
// //    {
// //        return false;
...
bool iterativePalindrome(const std::string &s) {
    ...
    // refer to the first, second, and last characters, respectively.
        ...
        // We need to loop through the string from the front and from the back
        // and work out way inward. We can declare variables to track this
        // and insert them into the loop
...
bool recursivePalindrome(const std::string &s, size_t leftIdx, size_t rightIdx) {
   ...
   // in the range s[leftIdx] ... s[rightIdx] form a palindrome.
        ...
        // next case: if LI + 1 and RI - 1 are equal, return true;
        if (s.at(leftIdx) != s.at(rightIdx)) {
            return false;
        }
    return recursivePalindrome(s, leftIdx + 1, rightIdx - 1);
...
int main() {
 ...
 // Uncomment the following calls to test functions as you finish
